...
def courses_fill():
    courses_data = (
        ...
        ("Технологии индустриального программирования", " Лекция", "Кафедра индустриального программирования"),
        ("Иностранный язык", "Практика", "Кафедра иностранных языков"),
        ("Правоведение", "Лекция", "Кафедра государственно-правовых дисциплин"),
        ("Физика", "Лекция", "Кафедра физики и технической механики"),
        ("Физика", "Практика", "Кафедра физики и технической механики"),
        ("Физика", "Лабароторная", "Кафедра физики и технической механики"),
        ("Линейная алгебра и аналитическая геометрия", "Практика", "Кафедра высшей математики-3"),
        ("Линейная алгебра и аналитическая геометрия", "Лекция", "Кафедра высшей математики-3"),
        ("Алгоритмы и структуры данных", "Практика", "Кафедра индустриального программирования"),
        ("Физическая культура и спорт (семестр 1)", "Практика", "Кафедра Физического воспитания"),
    )
    if creating_courses:
        for course_name, course_type, institute in courses_data:
            if Course.objects.filter(course_name=course_name, course_type=course_type).exists():
                course = Course(course_name=course_name, course_type=course_type, institute=institute)
                course.save()
